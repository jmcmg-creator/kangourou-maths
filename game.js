...
let state={screen:'home',level:null,mode:null,exercises:[],idx:0,selected:null,score:0,streak:0,maxStreak:0,results:[],timer:60,timerID:null,gameOver:false,startTime:null,gameData:null,detailOpen:false,sessionXP:0,sessionCristaux:0};
...
function pickExercises(mode,lvId){
  const pool=EX.filter(e=>e.lv===lvId);
  if(mode==='progression'){
